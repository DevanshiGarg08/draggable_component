...
List<List<PlayerModel>> playerCoordinates = [
  ...
  [
    ...
    PlayerModel(id: "D", point: const Point(2, 2)),
    PlayerModel(id: "E", point: const Point(4, 2)),
    PlayerModel(id: "E", point: const Point(3, 5)),
    PlayerModel(id: "F", point: const Point(1, 5)),
    PlayerModel(id: "G", point: const Point(5, 5)),
    PlayerModel(id: "H", point: const Point(3, 8)),
    PlayerModel(id: "I", point: const Point(1, 8)),
    PlayerModel(id: "J", point: const Point(5, 8)),
  ],
  //4-5-1
  [
    //2
    ...
    PlayerModel(id: "F", point: const Point(0, 5)),
    PlayerModel(id: "G", point: const Point(4, 5)),
    PlayerModel(id: "H", point: const Point(3, 8)),
    PlayerModel(id: "I", point: const Point(3, 6)),
    PlayerModel(id: "J", point: const Point(6, 5)),
  ],
  //3-4-3
  [
    //3
